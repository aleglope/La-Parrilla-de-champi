...
export const translations = {
  es: {
    ...
    hero: {
      ...
      description: 'Disfruta de las mejores carnes a la brasa en un ambiente acogedor y familiar.',
  ...
  gl: {
    ...
    hero: {
      ...
      description: 'Desfruta das mellores carnes á brasa nun ambiente acolledor e familiar.',
      cta: 'Ver Menú Completo',
      video: 'Ver Video'
    },
    story: {
