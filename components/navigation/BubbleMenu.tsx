...
export default function BubbleMenu({
  ...
  return (
    <>
      ...
      >
        {/* Logo bubble removed as requested */}
        ...
        <button
          ...
          className={[
            ...
            "rounded-full",
            "bg-charcoal-light", // Updated bg
            "shadow-[0_4px_16px_rgba(0,0,0,0.12)]",
            "pointer-events-auto",
            "w-12 h-12 md:w-14 md:h-14",
            "border-2 border-fire-red", // Added border
            "cursor-pointer p-0",
          ...
          // Remove inline style override to use class names
        >
          <span
              ...
              >
                <a
                  ...
                  className={[
                    ...
                    "rounded-[999px]",
                    "no-underline",
                    "bg-charcoal-light", // Updated default bg
                    "text-white", // Updated default text color
                    "border border-flame-blue/20", // Added subtle border
