  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
          ...
          {isLoading ? (
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="flex flex-col items-center gap-3">
                ...
                <span className="text-sm text-gray-400">Comprimiendo imagen...</span>
              </div>
            </div>
          ) : imageUrl ? (
            // Imagen
        ...
        {(compressedSizeKb || dimensions) && !isLoading && (
              ...
              {compressedSizeKb && (
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-gray-300">
                    <span className="font-semibold text-white">{compressedSizeKb.toFixed(1)}</span> KB
                  </span>
                </div>
              )}
            ...
            {compressedSizeKb && (
              <div className="mt-2">
                <div className="h-1.5 bg-charcoal rounded-full overflow-hidden">
                  <motion.div
                    initial={{ width: 0 }}
                    animate={{ width: `${Math.min((compressedSizeKb / 150) * 100, 100)}%` }}
                ...
                <p className="text-[10px] text-gray-500 mt-1">
                  {compressedSizeKb <= 150 ? '✓ Tamaño óptimo' : '⚠ Considera reducir el tamaño'}
                </p>
              </div>
            )}
          </div>
